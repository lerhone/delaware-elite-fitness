<nav>
	<ul>
		...
		<li id="nav_media"><a href="" title=""<? if($nav_on=='media') { echo ' class="on"';} ?>>Media</a></li>
		<li id="nav_store"><a href="" title=""<? if($nav_on=='store') { echo ' class="on"';} ?>>Store</a></li>
		<li id="nav_contact"><a href="" title=""<? if($nav_on=='contact') { echo ' class="on"';} ?>>Contact</a></li>
	</ul>
</nav>
